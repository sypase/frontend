...
//    onClose: () => void;
//    onClearHistory: () => void;
// }> = ({ historyMessages, onClose, onClearHistory }) => {
//    return (
...
//            className="mb-4 px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 transition-all duration-300"
//          >
//            Clear History
//          </button>
//          <div className="max-h-[400px] overflow-y-auto mb-4">
//            {historyMessages.map((msg) => (
//              <div key={msg.id} className={`p-3 rounded-lg ${msg.sender === 'user' ? 'bg-indigo-100' : 'bg-green-100'} mb-3`}>
//                <p>{msg.text}</p>
//              </div>
//            ))}
//          </div>
...
//    // Rewrite function to handle user input and API call
//    const rewrite = async () => {
//      if (text.length < 3 || loading) return;
...
//          sender: "bot",
//          text:
//            variants.length > 0 ? variants[0].text : response.data.output,
//          variants,
//          variantIndex: 0,
//          originalInput: text,
//        };
//        // Update both messages and history messages for local storage.
//        setMessages((prev) => [...prev, botMessage]);
//        setHistoryMessages((prev) => [...prev, botMessage]); // Add to history
...
//                    >
//                      History
//                      <FiHistory className="inline ml-2" />
//                    </button>

//                    {/* Variants navigation */}
//                    {/* ... (variant navigation buttons code here) ... */}
