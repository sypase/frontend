    ...
    <>
      ...
      {messages[messages.length - 1].text.includes("Not enough credits to proceed.") ? (
        <div className="error-content text-center">
          <div className="text-2xl font-bold text-center text-white mb-8 mt-6">
          ...
          <div className="pricing-plans text-center flex w-full justify-center gap-4">
            <div className="plan bg-gray-800/50 py-12 px-2 rounded-lg shadow-lg">
...
<div className="p-4 border-t border-gray-800">
  <div className="flex flex-wrap w-full overflow-hidden">
    <div className="w-full max-w-full">
      <HorizontalStepLoader loadingStates={aiStates} loading={true} />
    </div>
  </div>
</div>
                  ...
                  <div className="p-4 border-t border-gray-800 flex justify-between items-center">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm font-medium text-gray-400">
                        {100 - messages[messages.length - 1].variants![messages[messages.length - 1].variantIndex].score}% Human
                      </span>
                    </div>
                    <div className="flex items-center space-x-4">
                      <button
                        ...
                        disabled={messages[messages.length - 1].variantIndex === 0}
                      >
                        &lt;
                      </button>
                      ...
                      <button
                        ...
                        disabled={messages[messages.length - 1].variantIndex === messages[messages.length - 1].variants!.length - 1}
                      >
                        &gt;
                      </button>
                      <button
  className="px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 transition-all duration-300"
  onClick={() => copyToClipboard(messages[messages.length - 1].text)}
>
