...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <div className={`flex justify-center items-center w-full ${theme === 'dark' ? 'text-indigo-400' : 'text-indigo-600'}`}>
  <h2 className="text-4xl font-bold">With NoaiGPT, Humanize and Paraphrase with Ease</h2>
</div>
