...
>(({ className, children, color }, ref) => {
  return (
    <motion.div
      ref={ref}
      className={cn(
        "z-10 flex w-16 h-16 items-center justify-center rounded-full border-2 bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)]",
        className
      )}
...
export function AnimatedBeamMultipleOutputDemo({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-[100vh] w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-white p-10 md:shadow-l",
        className
      )}
      ref={containerRef}
    >
      ...
      <div className="flex justify-between items-center w-full max-w-3xl mb-12">
        <div className="flex items-center space-x-20">
          <div className="flex flex-col items-center">
            ...
            <p className="text-sm mt-2 text-center">OpenAI</p>
          </div>
          ...
          <div ref={noaigptContainerRef} className="flex flex-col items-center">
            ...
            <p className="text-sm mt-2 text-center">NoAIGPT</p>
          </div>
        </div>
