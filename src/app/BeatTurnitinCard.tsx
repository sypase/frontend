  ...
  return (
    <div className="container mx-auto p-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
        {/* Beat Turnitin Card */}
        <div className="md:col-span-2 relative group rounded-3xl bg-white border border-neutral-200 overflow-hidden hover:shadow-2xl transition-all duration-500 hover:scale-[1.01]">
