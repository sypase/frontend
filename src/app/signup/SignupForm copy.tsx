...
// //           Have an account?{" "}
// //           <Link href={"/login"}>
// //             <span className="text-blue-600 hover:text-blue-800 transition-colors duration-200">Log in</span>
// //           </Link>
// //         </p>
// //       </div>
// //       <style jsx>{`
...
//       const tokenId = response.credential;
//       const approvalState = "approved"; // Ensure this is set correctly
...
//         data: {
//           tokenId: tokenId,
//           approval_state: approvalState, // Include the approval_state parameter
//         },
//       };
