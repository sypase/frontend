...
const AICheckerShowcase = () => {
  ...
  return (
    ...
    >
      <div className="h-fit" style={{ paddingTop: "30px" }}>
        {/* Turnitin Text */}
        <h1
          className="turnitin-text  text-4xl md:text-6xl font-bold text-center mb-10"
          style={{
        ...
        <div className="text-center mb-10">
          <a
            ...
            className="join-discord-link text-xl font-semibold"
      ...
      {/* Image Showcase */}
      <div
        className="image-container hidden md:flex"
        style={{
      ...
      >
        ...
        />
        <img
          src="/assets/turnitin2.jpg"
          alt="Turnitin Screenshot 2"
          className="image2"
          style={{
            width: "100%",
            maxWidth: "45%",
